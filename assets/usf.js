/* USF file - DO NOT MODIFY THIS FILE. THIS FILE IS REGULARLY CHANGED BY USF APP AND **ANY DIRECT CHANGES WILL BE LOST**. Use our in-app customization if you need to update CSS and JS code. Auto modified at: 1/26/2022 12:56:20 AM*/
/* Begin custom theme code */
// define templates for the Minimal 2.0 theme
var _usfImageWidths;

var _usfMaxHeight = 255;
...
usf.event.add('init', function () {
    ...
    window.usf_sectionSettings = window.usf_sectionSettings || { show_sale_circle: true, show_sold_out_circle: true, center_grid_link: true, vendor_enable: true }
    _usfImageWidths = _usfIsDynamicImage ? [150, 220, 360, 470, 600, 750, 940, 1080, 1296, 1512, 1728, 2048] : [usf.settings.search.imageSize];
...
function _usfOnAddToCartSuccess(res, formSelector) {
    var $cartCount = $$$('.cart-count');

    toastr["success"](`Item "<b>${res.product_title}</b>" added to cart`)
    $.ajax({
        url: "/cart.json",
        type: "get",
        // async: false,
